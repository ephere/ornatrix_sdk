...
#define NOISE_MODIFIER_CLASS_ID Class_ID( 0x1864a0d9, 0xdb6e2f98 )
#define SMOOTH_SURFACE_MODIFIER_CLASS_ID Class_ID( 0x3acfc0aa, 0x8ca0e5d )
#define MERGE_MODIFIER_CLASS_ID Class_ID( 0xaf228972, 0xa56d57cf )
#define TRANSFER_NORMALS_MODIFIER_CLASS_ID Class_ID( 0x51bf9ec6, 0xfd509830 )
#define ORNAFILTER_MODIFIER_CLASS_ID Class_ID(0x335e164d, 0x21687493)
...
enum OrnatrixInterfaceIDs
{
	...
	//! Interface ID to use with a 3dsmax Animatable::GetInterface( ULONG ) method to get a pointer to Ephere::Ornatrix::IHair
	...
	//! Interface ID to use with a 3dsmax Animatable::GetInterface( ULONG ) method to get a pointer to Ephere::Geometry::IPolygonMeshSA
	IDistributionMeshInterfaceID = IHairInterfaceID + 14,
};
...
/** Gets Ornatrix hair interface from a 3dsmax object.
	@return IHair interface pointer if object was Ornatrix hair, nullptr otherwise
*/
inline Ephere::Ornatrix::IPolygonMeshSA* GetDistributionMeshInterface( Object& maxObject )
{
	return static_cast<Ephere::Ornatrix::IPolygonMeshSA*>( maxObject.GetInterface( Autodesk::Max::Ornatrix::IDistributionMeshInterfaceID ) );
}
